...
if __name__ == '__main__':
    ...
    parser.add_argument('--video', type=str, default= "datasets/training_data/Nancy_Sinatra/%04d.jpg")
    ...
    while True:
        ...
        if face is not None:
            ...
            if args.mode == "ident":
                ...
                # recognizer.predict(face["aligned"])
